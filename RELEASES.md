...
| Konkegram | Telegram for Android base |
| --- | --- |
| `1.1.0` | `12.9.0` |
...
| --- | --- | --- |
| `konkegram-v1.1.0-release-universal.apk` | ARM64, ARMv7, x86 and x86_64 | Android 5.0 or newer |
| `konkegram-v1.1.0-release-arm64-v8a.apk` | Most modern 64-bit ARM phones and tablets | Android 5.0 or newer |
| `konkegram-v1.1.0-release-armeabi-v7a.apk` | Older 32-bit ARM devices | Android 5.0 or newer |
